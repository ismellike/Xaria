...
namespace Xaria.Screens
{
    ...
    class End : Screen
    {
        ...
        internal override void Draw(ref SpriteBatch spriteBatch)
        {
            ...
            spriteBatch.DrawString(Game1.font, "You made it to level " + Game1.level.Difficulty + ".", new Vector2(Game1.screenSize.X/2f - 200, Game1.screenSize.Y - 500), Color.Yellow, 0f, Vector2.Zero, 2 * Game1.scale, SpriteEffects.None, 0f);
        }
